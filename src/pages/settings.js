    ...
    <div class="card" style="margin-bottom:0.75rem">
      ...
      <div class="field input-row">
        ...
        <div>
          ...
          <input class="input" type="text" id="s-vsk" placeholder="VSK númer" value="${esc(p.issuer_vsk)}" />
        </div>
      </div>
      <div class="field">
    ...
    <div class="card" style="margin-bottom:0.75rem">
      ...
      <div class="field input-row-3">
        <div>
          ...
          <input class="input" type="text" id="s-utibú" placeholder="Útibú" value="${esc(p.bank_utibú)}" />
        </div>
        <div>
    ...
    <div class="card" style="margin-bottom:0.75rem">
      ...
      <div class="field input-row">
        <div>
          ...
          <input class="input" type="number" id="s-rate" placeholder="Tímakaup" value="${esc(p.default_rate)}" />
        </div>
        <div>
